...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1480, 120)
        self.frame = QtWidgets.QFrame(Form)
        self.frame.setGeometry(QtCore.QRect(0, 0, 1480, 120))
        ...
        self.label_1.setGeometry(QtCore.QRect(20, 30, 120, 60))
        self.label_1.setStyleSheet("font: 14pt \"微软雅黑\";")
        self.label_1.setAlignment(QtCore.Qt.AlignCenter)
        self.label_1.setObjectName("label_1")
        self.min_version = QtWidgets.QLineEdit(self.frame)
        self.min_version.setGeometry(QtCore.QRect(140, 30, 120, 60))
...
"color: rgb(0, 0, 255);")
        ...
        self.label_2.setGeometry(QtCore.QRect(280, 30, 120, 60))
        self.label_2.setStyleSheet("font: 14pt \"微软雅黑\";")
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.max_version = QtWidgets.QLineEdit(self.frame)
        self.max_version.setGeometry(QtCore.QRect(400, 30, 120, 60))
...
"color: rgb(0, 0, 255);")
        ...
        self.label_3.setGeometry(QtCore.QRect(540, 30, 120, 60))
        self.label_3.setStyleSheet("font: 14pt \"微软雅黑\";")
        self.label_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_3.setObjectName("label_3")
        self.priority = QtWidgets.QLineEdit(self.frame)
        self.priority.setGeometry(QtCore.QRect(660, 30, 120, 60))
...
"color: rgb(0, 0, 255);")
        ...
        self.label_4.setGeometry(QtCore.QRect(800, 30, 120, 60))
        self.label_4.setStyleSheet("font: 14pt \"微软雅黑\";")
        self.label_4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_4.setObjectName("label_4")
        self.tip = QtWidgets.QTextEdit(self.frame)
        self.tip.setGeometry(QtCore.QRect(920, 20, 540, 80))
        self.tip.setStyleSheet("font: 12pt \"微软雅黑\";\n"
"color: rgb(0, 0, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "提示语"))
