...
class AddGiftDialog(QDialog, Ui_Dialog):
    ...
    __select_gift_name = OVERALL_GIFT_WALL_FILE_NAME
    ...
    def __init__(self, parent=None, add_gift_item_list=None):
        ...
        self.__server_gift_wall_file = [self.OVERALL_GIFT_WALL_FILE_NAME]
    ...
    def __set_table_widget(self):
        ...
        if download.overall_gift_entity and download.overall_gift_entity.item_list:
            if self.OVERALL_GIFT_WALL_FILE_NAME == self.__select_gift_name:
